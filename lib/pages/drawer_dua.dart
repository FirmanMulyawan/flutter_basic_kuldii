...
import '../pages/drawer_satu.dart';

class DrawerPageSettings extends StatelessWidget {
  const DrawerPageSettings({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Drawer Settings'),
      ...
      body: const Center(
          child: Text('Ini halaman Settings', style: TextStyle(fontSize: 25))),
    );
  }
}
